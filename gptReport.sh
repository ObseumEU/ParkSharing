...
exclude_path="src/ParkingReservationApp/client-app/node_modules"
...
echo "--------------------------------------------------"
echo "File: ./src/ParkingReservationApp/client-app/src/App.js"
echo "--------------------------------------------------"
cat "./src/ParkingReservationApp/client-app/src/App.js"



echo "--------------------------------------------------"
echo "File: ./src/ParkingReservationApp/client-app/package.json"
echo "--------------------------------------------------"
cat "./src/ParkingReservationApp/client-app/package.json"


echo "--------------------------------------------------"
echo "File: src/ParkingReservationApp/client-app/src/CustomChatbot.js"
echo "--------------------------------------------------"
cat "src/ParkingReservationApp/client-app/src/CustomChatbot.js"

echo "--------------------------------------------------"
echo "File: src/ParkingReservationApp/client-app/src/MessageParser.jsx"
echo "--------------------------------------------------"
cat "src/ParkingReservationApp/client-app/src/MessageParser.jsx"

echo "--------------------------------------------------"
echo "File: src/ParkingReservationApp/client-app/src/config.js"
echo "--------------------------------------------------"
cat "src/ParkingReservationApp/client-app/src/config.js"

echo "--------------------------------------------------"
echo "File: src/ParkingReservationApp/client-app/src/ActionProvider.jsx"
echo "--------------------------------------------------"
cat "src/ParkingReservationApp/client-app/src/ActionProvider.jsx"

echo "--------------------------------------------------"
echo "File: src/ParkingReservationApp/client-app/src/index.css"
echo "--------------------------------------------------"
cat "src/ParkingReservationApp/client-app/src/index.css"